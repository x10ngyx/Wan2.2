...
def parse_args(training=False):
    ...
    if not training:
        ...
        parser.add_argument("--logdate-dir", default=None, type=str2bool, help="log datetime in save path")
    ...
    # ======================================================
        ...
        parser.add_argument("--codebook", default=None, type=bool, help="enable wandb")
...
def merge_args(cfg, args, training=False):
    ...
    if not training:
        ...
        if args.num_sampling_steps is not None:
            ...
            cfg.model["num_sampling_steps"] = args.num_sampling_steps
