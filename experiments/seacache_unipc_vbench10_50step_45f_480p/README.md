# SeaCache UniPC VBench10 50-step 45f 480p

Runs timestep-cache-only SeaCache on `test_sets/Vbench10/prompts.jsonl` with
...
```bash
bash experiments/seacache_unipc_vbench10_50step_45f_480p/run_tmux.sh
```

The default output root is:

```text
/hy-tmp/wan22_seacache_unipc_vbench10_50step_45f_480p_<timestamp>
```
